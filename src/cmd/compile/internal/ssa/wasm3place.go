...
func wasm3IsDirectAnyref(v *Value) bool {
	...
	case OpWasm3StructNew, OpWasm3StructNewDefault,
		...
		OpWasm3StackArray, OpWasm3StackStruct, OpWasm3MakeSlice, OpWasm3MakeMap, OpWasm3SubSlice, OpWasm3SliceData, OpWasm3StringData, OpWasm3IfaceItab, OpWasm3IfaceData, OpWasm3IfaceMake,
...
func wasm3PointerIsRef(v *Value) bool {
	...
	e := t.Elem()
	return e != nil && (e.IsStruct() || e.IsArray() || e.IsString() || e.IsSlice() || e.IsInterface())
}
